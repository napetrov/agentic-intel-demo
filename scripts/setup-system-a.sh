...
ANTHROPIC_DEFAULT_SONNET_MODEL="${ANTHROPIC_DEFAULT_SONNET_MODEL:-arn:aws:bedrock:us-east-2:372075448100:application-inference-profile/7dupg9shizme}"
BEDROCK_MODEL_ID="${BEDROCK_MODEL_ID:-us.anthropic.claude-sonnet-4-6}"
TELEGRAM_ALLOWED_FROM="${TELEGRAM_ALLOWED_FROM:-293894843}"
SESSION_IMAGE="${SESSION_IMAGE:-docker.io/library/demo-session-pod:latest}"
CONTROL_IMAGE="${CONTROL_IMAGE:-docker.io/library/demo-control-plane:latest}"
...
export SYSTEM_B_VLLM_ENDPOINT SYSTEM_B_MINIO_ENDPOINT CONTROL_PLANE_TOKEN MINIO_ACCESS_KEY MINIO_SECRET_KEY TELEGRAM_BOT_TOKEN AWS_REGION AWS_BEARER_TOKEN_BEDROCK SAMBANOVA_API_KEY ANTHROPIC_DEFAULT_SONNET_MODEL BEDROCK_MODEL_ID TELEGRAM_ALLOWED_FROM SESSION_IMAGE CONTROL_IMAGE
